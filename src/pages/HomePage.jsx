      ...
      <div className="container mx-auto px-4">
        <div className="hero grid md:grid-cols-2 grid-cols-1 items-center gap-20 pt-32">
          <div className="box">
            ...
            <p className="text-base/8 mb-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut aliquid nam, eius ratione vero error tempora exercitationem cupiditate officiis dolor?</p>
            <a href="#" className="bg-sky-400 hover:bg-sky-500 transition-all py-2 px-4 text-white shadow rounded-full">
              Tentang Kami <i className="ri-eye-line ms-1"></i>
            </a>
          </div>
          <div className="box">
            <img src={HeroImage} alt="Hero Image" className="md:w-full w-[400px] mx-auto md:m-0" loading="lazy" />
          </div>
        </div>

        <div className="about grid md:grid-cols-2 grid-cols-1 items-center md:gap-20 gap-10 md:pt-20 pt-32" id="about">
          <div className="box md:order-1 order-2">
            <img src={AboutImage} alt="About Image" className="lg:w-[500px] w-[400px] md:m-0 mx-auto" loading="lazy" />
          </div>
          <div className="box md:order-2 order-1">
            <h1 className="lg:text-5xl/tight text-3xl font-medium mb-7">
              Belajar Membuat Website Dengan <span className="font-bold text-sky-400 underline">Tailwind CSS</span>
            </h1>
            <p className="text-base/loose">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut aliquid nam, eius ratione vero error tempora exercitationem cupiditate officiis dolor?</p>
          </div>
        </div>
        ...
        <div className="services pt-32" id="services">
          ...
          <div className="services-box pt-12 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box bg-sky-400 rounded-lg shadow p-4">
              ...
              <p className="text-white text-base/loose">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deserunt optio exercitationem sint nobis maiores? Dicta?</p>
            </div>
            <div className="box bg-sky-400 rounded-lg shadow p-4">
        ...
        <div className="proyek pt-32" id="proyek">
          ...
          <div className="proyek-box pt-12 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box p-2 bg-white shadow">
              <img src={Proyek1} alt="Proyek Image" className="w-full h-[220px]" loading="lazy" />
              <h3 className="text-xl font-bold  mt-6 mb-2">Proyek Name 1</h3>
              <p className=" text-base/loose">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugit debitis at quod dolores amet. Maxime?</p>
            </div>
            <div className="box p-2 bg-white shadow">
              <img src={Proyek2} alt="Proyek Image" className="w-full h-[220px]" loading="lazy" />
              <h3 className="text-xl font-bold  mt-6 mb-2">Proyek Name 2</h3>
              <p className=" text-base/loose">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugit debitis at quod dolores amet. Maxime?</p>
            </div>
            <div className="box p-2 bg-white shadow">
              <img src={Proyek3} alt="Proyek Image" className="w-full h-[220px]" loading="lazy" />
              <h3 className="text-xl font-bold  mt-6 mb-2">Proyek Name 3</h3>
              <p className=" text-base/loose">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugit debitis at quod dolores amet. Maxime?</p>
            </div>
            <div className="box p-2 bg-white shadow">
              <img src={Proyek4} alt="Proyek Image" className="w-full h-[220px]" loading="lazy" />
              <h3 className="text-xl font-bold  mt-6 mb-2">Proyek Name 4</h3>
              <p className=" text-base/loose">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugit debitis at quod dolores amet. Maxime?</p>
            </div>
            <div className="box p-2 bg-white shadow">
              <img src={Proyek5} alt="Proyek Image" className="w-full h-[220px]" loading="lazy" />
